	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo base_url(). 'daftar/aksi_daftar'; ?>" method="post">
					<span class="login100-form-title">
						Daftar Karyawan
					</span>

                    <div class="wrap-input100 validate-input" data-validate = "Isikan nama lengkap">
					...
					<div class="wrap-input100 validate-input" data-validate = "Email valid diperlukan: rezzy@mail.com">
...
<!--===============================================================================================-->
	<script src="<?php echo base_url(); ?>template/Login/vendor/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
